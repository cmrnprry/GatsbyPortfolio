...
import Escapril from './PDFs/Escapril.pdf'
        ...
        <div className={style.container}>
          <div className={style.post}
            ...
            >
                ...
                <p>A short, horror story, that uses font, word size and formatting to create interactivity in a linear narrative</p>
            </a>
          </div>
          ...
          <div className={style.post}
            ...
            >
                <h2>Short Story</h2>
                <p>A short excerpt written during one day out of a month long writing challenge</p>
            </a>
          </div>
